...
namespace Delay
{
    ...
    public static class MinimizeToTray
    {
        ...
        public static void SetToolTip(string tTip)
        {
            toolTip = tTip;
        }
        ...
        private class MinimizeToTrayInstance
        {
            ...
            private void HandleStateChanged(object sender, EventArgs e)
            {
                ...
                _window.ShowInTaskbar = false;//!minimized;
                _notifyIcon.Visible = minimized;
                if (minimized && !_balloonShown)
                {
                    // If this is the first time minimizing to the tray, show the user what happened
                    _notifyIcon.ShowBalloonTip(1000, null, MinimizeToTray.toolTip, ToolTipIcon.None);
                    //_balloonShown = true;
                }
            }
            ...
            private void HandleNotifyIconOrBalloonClicked(object sender, EventArgs e)
            {
                ...
                _window.Topmost = SortingStatus.UCPrgBar.topMost;
            }

            void _notifyIcon_Click(object sender, EventArgs e)
            {
                HandleNotifyIconOrBalloonClicked(sender, e);
            }
        }
    }
}
